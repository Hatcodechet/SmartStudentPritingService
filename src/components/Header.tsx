...
const Header: React.FC = () => {
  ...
  return (
    <>
      <header className="min-h-[4rem] flex items-center justify-between w-full border-b border-slate-300">
        <Link
          to="/"
          className="py-2 flex flex-row justify-between border border-r-slate-300 w-[14rem] h-full"
        >
          <img src={Logo} alt="Bach Khoa Logo" className="" />
          <div className="flex flex-col items-center text-center justify-center">
            <p className="text-[0.6rem]">
              Ho Chi Minh University of Technology
            </p>
            <p className="text-[0.8rem] font-bold text-blue-400">
